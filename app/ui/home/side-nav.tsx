...
const Sidebar = () => (
  <div className="hidden md:flex flex-col gap-2 h-full max-h-screen">
    <div className="flex h-14 lg:h-16 items-center justify-end bg-muted/40 border-b px-4 lg:px-6">
      <Sheet>
